				...
				<div class="span4">
					<div class="well">
						...
						<form:form action="dang-ky" method="POST" modelAttribute="user">
							...
							<div class="control-group">
								<label class="control-label" for="inputPassword">mat
									khau</label>
								<div class="controls">
									<form:input type="password" class="span3"
										placeholder="Mat khau" path="password" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="inputPassword">ho va
									ten</label>
								<div class="controls">
									<form:input type="text" class="span3" placeholder="ho va ten"
										path="display_name" />
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<form:input type="text" class="span3" placeholder="dia chi"
										path="address" />
								</div>
							</div>
							<div class="controls">
				...
				<div class="span4">
					<div class="well">
						...
						<form:form action="dang-nhap" method="POST" modelAttribute="user">
							...
							<div class="control-group">
								<div class="controls">
									<button type="submit" class="defaultBtn">Dang nhap</button>
