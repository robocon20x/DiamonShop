	...
	<div class="row product-content">
		...
		<div class="span9">
			<ul class="breadcrumb">
				...
				<li><a href="products.html">San pham</a> <span class="divider">/</span></li>
			...
			<div class="well well-small">
						...
						<div id="myCarousel" class="carousel slide cntr">
							<div class="carousel-inner">
								<div class="item active">
									<a href="#"> <img
										src="<c:url value ="/assets/user/img/${product[0].img}"/>"
				...
				<ul id="productDetail" class="nav nav-tabs">
					<li class="active"><a href="#home" data-toggle="tab">Chi
							tiet san pham</a></li>
					<li class=""><a href="#profile" data-toggle="tab">San pham
							lien quan </a></li>

				</ul>
				<div id="myTabContent" class="tab-content tabWrapper">
					<div class="tab-pane fade active in" id="home">
						${product[0].details}</div>
